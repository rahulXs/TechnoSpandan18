...
import com.example.streak.technospandan.utils.CEventCardsUtils;
...
public class CMainFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final RecyclerView recyclerView = view.findViewById(R.id.crvCards);
        ...
        mAdapter.addAll(CEventCardsUtils.generateSportCards());
