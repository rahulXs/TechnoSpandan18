...
import com.example.streak.technospandan.utils.ImageUploadInfo;
...
public class ImgUploadActivity extends AppCompatActivity {
    ...
    public void UploadImageFileToFirebaseStorage() {
        ...
        if (FilePathUri != null) {
            ...
            storageReference2nd.putFile(FilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toasty.success(getBaseContext(), "Image Uploaded Successfully ", Toast.LENGTH_SHORT, true).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(ImgUploadActivity.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toasty.error(getBaseContext(), "Please Select Image or Add Image Name", Toast.LENGTH_SHORT, true).show();
